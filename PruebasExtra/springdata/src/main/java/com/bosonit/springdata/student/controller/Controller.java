package com.bosonit.springdata.student.controller;

import com.bosonit.springdata.student.application.StudentService;
...
public class Controller {
    ...
    @PostMapping
    public ResponseEntity<StudentOutputDto>  addStudent(
            @RequestBody StudentInputDto student){
